                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="product.php" class="sidebar-link">
                            <i class="fa-regular fa-box pe-2"></i>
                            Products
                        </a>
                    </li>
                    <li class="sidebar-item">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" class="nav-icon pe-md-0">
                                <img src="432960952_1169158481122536_5993411717618387454_n.png" class="avatar img-fluid rounded" alt="">
                            </a>
                                ...
                                <table>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Edit button -->
                                                <button onclick="showEditForm(<?php echo $row['id']; ?>, '<?php echo $row['name']; ?>', '<?php echo $row['email']; ?>')"><i class="fas fa-pen-to-square"></i> Edit</button>
                                                <!-- Delete button -->
